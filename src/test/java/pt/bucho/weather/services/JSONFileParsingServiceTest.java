...
public class JSONFileParsingServiceTest {
	...
	public void happyPath() {
		...
		WeatherData actualWeatherData = actualRequest.getCurrently();
		WeatherData expectedWeatherData = expectedRequest.getCurrently();
		
		assertEquals(expectedWeatherData.getTime(), actualWeatherData.getTime());
		assertEquals(expectedWeatherData.getSummary(), actualWeatherData.getSummary());
		assertEquals(expectedWeatherData.getIcon(), actualWeatherData.getIcon());
		assertEquals(expectedWeatherData.getPrecipIntensity(), actualWeatherData.getPrecipIntensity());
		actualWeatherData.setPrecipProbability(0d);
		actualWeatherData.setTemperature(15.51d);
		actualWeatherData.setApparentTemperature(15.51d);
		actualWeatherData.setDewPoint(12.45d);
		actualWeatherData.setHumidity(0.81d);
		actualWeatherData.setWindSpeed(7.45d);
		actualWeatherData.setWindBearing(0d);
		actualWeatherData.setCloudCover(0.4d);
		actualWeatherData.setPressure(1023.68d);
		actualWeatherData.setOzone(347.55d);
		expectedRequest.setCurrently(actualWeatherData);
