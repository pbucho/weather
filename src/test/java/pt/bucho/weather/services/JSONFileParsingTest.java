...
public class JSONFileParsingTest extends AbstractTest {
	...
	public void happyPath() {
		...
		assertWeatherData(expectedRequest.getCurrently(), actualRequest.getCurrently());
		
		HourlyWeatherData expectedHourlyData = expectedRequest.getHourly();
		HourlyWeatherData actualHourlyData = actualRequest.getHourly();
		...
		DailyWeatherData expectedDailyData = expectedRequest.getDaily();
		DailyWeatherData actualDailyData = actualRequest.getDaily();
	...
	private void assertString(String expected, String actual) {
		if (expected == null) {
	...
	private void assertDouble(Double expected, Double actual, double delta) {
		if (expected == null) {
			if (actual != null) {
